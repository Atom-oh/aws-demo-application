...
helm.sh/chart: {{ include "resume-service.chart" . }}
{{ include "resume-service.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
{{- default (include "resume-service.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
Get the namespace
*/}}
{{- define "resume-service.namespace" -}}
{{- if .Values.global }}
...
*/}}
{{- define "resume-service.istioLabels" -}}
{{- if .Values.global }}
...
*/}}
{{- define "resume-service.irsaAnnotation" -}}
...
eks.amazonaws.com/role-arn: {{ .Values.global.irsa.roleArnPrefix }}/hirehub-resume-service-role
{{- end }}
{{- end }}
{{- end }}
{{- end }}
...
*/}}
{{- define "resume-service.environment" -}}
{{- if .Values.global }}
